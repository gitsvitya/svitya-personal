...
export const rusLng = {
  ...
  titleBlockSubHeader:
    "Управление проектами, разработка продуктов, исследования и аналитика",
  ...
  cookieBannerBlockParagraphText:
  ...
  workExpBlockCompanyTitleLRNPT:
    "Ведущий специалист отдела развития бизнеса и анализа рынков",
  workExpBlockCompanyAboutLRNPT:
  ...
  otherExpBlockCompanyResultsSKO:
  ...
  otherExpBlockCompanyResultsSDC:
...
export const engLng: Dictionary = {
  ...
  workExpBlockCompanyAboutNTB:
    "A subsidiary of the Moscow Exchange specializing in commodity markets.",
  workExpBlockCompanyResultsNTB:
  ...
  workExpBlockCompanyTitleLRNPT:
    "Leading Specialist, Business Development and Market Analysis",
  workExpBlockCompanyAboutLRNPT:
